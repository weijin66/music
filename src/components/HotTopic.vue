<template>
  <div class="border-b-[0.1vw] dark:border-[#23252c]">
    ...
    <div
      class="scroll-wrapper ml-[3vw] w-[89vw] rounded-[2vw] overflow-hidden"
      ref="scroll"
    >
      <ul class="scroll-content flex w-[375vw] m-[2vw] ml-[2vw]">
        <li class="scroll-item rounded-[2vw] w-[60vw] h-[28vw] bg-[#d1b278]">
          <div>
            <div class="mt-[2vw] ml-[2vw] flex text-[white] dark:text-[#fff]">
              <Icon icon="icon-park-solid:topic" class="mt-[1vw]" />
              <span>云村最会拍照的人！</span>
            </div>
            <span
              class="text-[#747474] dark:text-[#fff] mt-[2vw] ml-[2vw] text-[2vw]"
              >28万热度</span
            >
            <div class="flex justify-between">
              <div
                class="text-[1vw] text-[#fff] dark:text-[#fff] ml-[1vw] w-[30vw] whitespace-normal"
              >
                还在听《feat. Rich Homie》吗|时光雷达
              </div>
              <img
                src="http://p2.music.126.net/68UCWFRROM30HihOi8LhGQ==/109951167758162478.jpg"
        ...
        >
          <div>
            ...
            <div class="flex justify-between">
              ...
              <img
                src="http://p2.music.126.net/68UCWFRROM30HihOi8LhGQ==/109951167758162478.jpgpg"
                class="mr-[2vw] mt-[-3vw] w-[14vw] rounded-[2vw]"
              />
            </div>
          </div>
